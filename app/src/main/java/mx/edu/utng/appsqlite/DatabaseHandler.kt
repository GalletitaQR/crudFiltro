...
class DatabaseHandler(context: Context): SQLiteOpenHelper(context,DATABASE_NAME,null,DATABASE_VERSION) {
    ...
    fun updateEmployee(emp: EmpModelClass): Int {
        ...
        // Evitar concatenación directa, usar parámetros en lugar de concatenar
    ...
    fun updateEmployee(employee: Employee): Long {
        val db = this.writableDatabase
        val contentValues = ContentValues().apply {
            put(KEY_NAME, employee.name)
            put(KEY_EMAIL, employee.email)
        }

        // Verifica si el ID es del tipo correcto
        return db.update(TABLE_CONTACTS, contentValues, "$KEY_ID = ?", arrayOf(employee.id.toString())).toLong()
    }
